...
func DatingGoalCompatibilityMatrix() map[uint]map[uint]float64 {
	return map[uint]map[uint]float64{
		1: {1: 1.0, 2: 0.2, 3: 0.7, 4: 0.0, 5: 0.8},
		2: {1: 0.2, 2: 1.0, 3: 0.9, 4: -1.0, 5: 0.2},
		3: {1: 0.7, 2: 0.9, 3: 1.0, 4: 0.3, 5: 0.5},
		4: {1: 0.0, 2: -1.0, 3: 0.3, 4: 1.0, 5: 0.4},
		5: {1: 0.8, 2: 0.2, 3: 0.5, 4: 0.4, 5: 1.0},
	}
}
...
func AttitudeCompatibilityMatrix() map[uint]map[uint]float64 {
	return map[uint]map[uint]float64{
		1: {1: 1.0, 2: 0.8, 3: 0.0, 4: -1.0},
		2: {1: 0.8, 2: 1.0, 3: 0.4, 4: -0.8},
		3: {1: 0.0, 2: 0.4, 3: 1.0, 4: 0.5},
		4: {1: -1.0, 2: -0.8, 3: 0.5, 4: 1.0},
	}
}
